...
const CompanyLogosOne = ({ paymentVisible }) => {
  const router = useRouter();

  const onClickHelper = (page) => {
    router.push(page);
  };
  return (
    <>
        ...
        <section className="py-10">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-300 uppercase">
            ...
            <div className="mt-12 max-w-4xl mx-auto flex items-center justify-center flex-wrap">
              {companies.map((company) => (
                <div
                  key={company.id}
                  className="dark:bg-gray-300 rounded-md h-20 w-48 my-4 mx-4"
                >
                  <img
      ...
      <footer className="container mx-auto px-10 md:px-0 py-10">
        ...
        <div className="mt-8">
          <ul className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-6 lg:space-x-12 items-start md:items-center font-semibold text-base text-gray-700 dark:text-gray-100">
            <li
              onClick={() => onClickHelper("/info/about-us")}
              className="cursor-pointer"
            >
              About us
            </li>
            <li
              onClick={() => onClickHelper("/info/refund-cancellation")}
              className="cursor-pointer"
            >
              Refund Cancellation Policy
            </li>
            <li
              onClick={() => onClickHelper("/info/vision")}
              className="cursor-pointer"
            >
              Our Vision
            </li>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          consectetur voluptatibus, nostrum explicabo, quisquam nisi ipsum
          asperiores nam deleniti quo excepturi aliquam quam. Accusamus officiis
          beatae quaerat obcaecati, consectetur ullam quibusdam saepe non
          blanditiis natus quisquam totam. Vitae magni, maiores eveniet ut qui
          quaerat at iure, ipsum ducimus, temporibus in.
        </p>
      </footer>
    </>
  );
...
export default CompanyLogosOne;
